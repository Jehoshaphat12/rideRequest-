...
export default function RequestDeliveryScreen() {
  ...
  const handleRequestDelivery = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Delivery Requested!",
        `Your delivery has been scheduled. Estimated fee: GHS ${estimatedFare.toFixed(
          2
        ...
        [
          {
            ...
            onPress: () =>
              router.push(
                `/(passenger)/deliveryTracking?deliveryId=${deliveryId}`
              ),
          },
        ]
      );
      ...
      Alert.alert(
        "Error",
        error.message || "Failed to request delivery. Please try again."
      );
    } finally {
      setLoading(false);
    }
        ...
        <ScrollView style={styles.scrollView}>
            ...
            <View style={styles.inputGroup}>
              <View style={styles.inputHeader}>
                ...
                <TouchableOpacity onPress={useCurrentLocationForPickup}>
                  <Text
                    style={[styles.useCurrentText, { color: theme.primary }]}
                  >
              ...
              {(["small", "medium", "large"] as const).map((size) => (
                ...
                >
                  <Ionicons
                    ...
                    size={24}
                    color={
                      packageSize === size ? theme.primaryText : theme.text
                    }
                  />
                  <Text
                    style={[
          ...
          <View style={[styles.section, { backgroundColor: theme.card }]}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setForm((prev) => ({ ...prev, recipientName: text }))
                }
              />
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setForm((prev) => ({ ...prev, recipientPhone: text }))
                }
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setForm((prev) => ({ ...prev, packageDescription: text }))
                }
              />
            </View>
          ...
          <View style={styles.actionContainer}>
            <TouchableOpacity
              ...
              disabled={
                calculatingFare || !locations.pickup || !locations.dropoff
              }
            >
              <Text
                style={[styles.estimateButtonText, { color: theme.primary }]}
              >
            ...
            >
              <Text
                style={[styles.requestButtonText, { color: theme.primaryText }]}
              >
